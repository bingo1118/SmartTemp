...
public class SystemDataManager {
    ...
    public ArrayList<HashMap<String,String>> getSysBells(Context context){
        ...
        while(result.moveToNext()){
            ...
            int bellId = result.getInt(result.getColumnIndex(MediaStore.MediaColumns._ID));
    ...
    public HashMap<String,String> findSystemBellById(Context context,int bellId){
        ...
        ContentResolver resolver = context.getContentResolver();
        Cursor result = resolver.query(MediaStore.Audio.Media.INTERNAL_CONTENT_URI, null, MediaStore.MediaColumns._ID+"=?", new String[]{String.valueOf(bellId)}, MediaStore.Audio.Media.DEFAULT_SORT_ORDER);
        while(result.moveToNext()){
    ...
    public HashMap<String,String> findSdBellById(Context context,int bellId){
        HashMap<String,String> data = new HashMap<String,String>();
        ContentResolver resolver = context.getContentResolver();
        Cursor result = resolver.query(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, null, MediaStore.MediaColumns._ID+"=?",
