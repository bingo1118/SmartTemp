...
public class PassRecordByPersonIdActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pass_record_by_person_id);
    ...
    private void getPassPersonData() {
        RequestCenter.getPassRecordByPersonId(personId, page+"", new DisposeDataListener() {
            @Override
